...
Die Deliverables Liste (Liefergegenstandsliste) stellt sicher, dass alle wesentlichen Ergebnisse des Projekts klar definiert und termingerecht geliefert werden. Diese Liste umfasst alle Produkte, Dienstleistungen, Dokumentationen oder sonstigen Ergebnisse, die während des Projektverlaufs an die Stakeholder übergeben werden müssen. Die zuvor gezeigte Aufstellung der Arbeitspakete zeigt detailliert, welche Aufgaben zu erledigen sind, wer dafür verantwortlich ist, welche Ressourcen benötigt werden und in welchem Zeitraum die Aufgaben abgeschlossen sein sollen.
